...
- **id:** `0017-pass-1c`
- **status:** `superseded`
- **archive kind:** historical design
- **superseded by:** [Completed Pass 1c](../completed/0017-pass-1c.md)
...
>
> - [`planning/iterations/`](../../iterations/) — current selected work.
> - [`planning/backlog.md`](../../backlog.md) — unscheduled follow-up items.
> - [`rollup-roadmap-register-2026-06.md` §"Pass 1c — analyzer-defined
>   invocations + post-bench results-analyzer"](rollup-roadmap-register-2026-06.md)
>   — archived
>   register entry listing what shipped vs what was deferred.
...
**Pass 1c** — *Now.* ~25-30 h + prompt-iteration calendar. (Historical full
design:
[rollup-roadmap-register-2026-06.md §"Pass 1c — analyzer-defined invocations +
post-bench results-analyzer"](rollup-roadmap-register-2026-06.md).)
...
numbers are quotable. See
[rollup-roadmap-register-2026-06.md](rollup-roadmap-register-2026-06.md) entries:
